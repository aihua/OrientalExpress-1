...
public class FastMessage extends GroupValue {
	private static final long serialVersionUID = 1L;
	private final MessageTemplate template;

	public FastMessage(MessageTemplate template, FieldValue[] fieldValues) {
		super(template, fieldValues);
		this.template = template;
	}

	public FastMessage(MessageTemplate template) {
	...
	public boolean equals(Object obj) {
		if ((obj == null) || !(obj instanceof FastMessage)) {
			return false;
		}
		return equals((FastMessage) obj);
	}

	public boolean equals(FastMessage message) {
	...
	public FieldValue copy() {
		...
		return new FastMessage(template, this.values);
	}
}
