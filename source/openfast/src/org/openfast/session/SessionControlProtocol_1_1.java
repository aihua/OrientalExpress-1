...
public class SessionControlProtocol_1_1 extends AbstractSessionControlProtocol {
	...
	protected QName getQName(FastMessage message) {
	...
	public FastMessage createHelloMessage(String senderName) {
	...
	public FastMessage createTemplateDeclarationMessage(MessageTemplate messageTemplate, int templateId) {
		FastMessage declaration = new FastMessage(TEMPLATE_DECLARATION);
	...
	public FastMessage createTemplateDefinitionMessage(MessageTemplate messageTemplate) {
		FastMessage templateDefinition = GroupConverter.convert(messageTemplate, new FastMessage(TEMPLATE_DEFINITION),
				initialContext);
	...
	//NGTS Enhancement for GBK support
	public static final int GBK_INSTR_ID = 20000;
	...
	public static final FastMessage RESET = new FastMessage(FAST_RESET_TEMPLATE) {
	...
	private static final MessageTemplate OTHER = new MessageTemplate(
			new QName("Other", NAMESPACE),
			new Field[] { new Group(qualify("Other"), new Field[] {
	...
	private static final MessageTemplate TEMPLATE_NAME = new MessageTemplate(new QName("TemplateName", NAMESPACE),
			new Field[] { dict("Ns", Type.UNICODE, false, Dictionary.TEMPLATE),
	...
	private static final MessageTemplate NS_NAME_WITH_AUX_ID = new MessageTemplate(
			new QName("NsNameWithAuxId", NAMESPACE), new Field[] { new StaticTemplateReference(NS_NAME),
					new Scalar(qualify("AuxId"), Type.UNICODE, Operator.NONE, null, true) });
	private static final MessageTemplate FIELD_BASE = new MessageTemplate(new QName("PrimFieldBase", NAMESPACE),
			new Field[] { new StaticTemplateReference(NS_NAME_WITH_AUX_ID),
					new Scalar(qualify("Optional"), Type.U32, Operator.NONE, null, false), new StaticTemplateReference(OTHER) });
	private static final MessageTemplate PRIM_FIELD_BASE = new MessageTemplate(new QName("PrimFieldBase", NAMESPACE),
			new Field[] { new StaticTemplateReference(FIELD_BASE),
					new Group(qualify("Operator"), new Field[] { DynamicTemplateReference.INSTANCE }, true) });
	private static final MessageTemplate LENGTH_PREAMBLE = new MessageTemplate(new QName("LengthPreamble", NAMESPACE),
			new Field[] { new StaticTemplateReference(NS_NAME_WITH_AUX_ID), new StaticTemplateReference(OTHER) });
	private static final MessageTemplate PRIM_FIELD_BASE_WITH_LENGTH = new MessageTemplate(new QName(
			"PrimFieldBaseWithLength", NAMESPACE), new Field[] { new StaticTemplateReference(PRIM_FIELD_BASE),
			new Group(qualify("Length"), new Field[] { new StaticTemplateReference(LENGTH_PREAMBLE) }, true) });
	public static final MessageTemplate INT32_INSTR = new MessageTemplate(new QName("Int32Instr", NAMESPACE),
			new Field[] { new StaticTemplateReference(PRIM_FIELD_BASE),
					new Scalar(qualify("InitialValue"), Type.I32, Operator.NONE, null, true) });
	public static final MessageTemplate UINT32_INSTR = new MessageTemplate(new QName("UInt32Instr", NAMESPACE),
			new Field[] { new StaticTemplateReference(PRIM_FIELD_BASE),
					new Scalar(qualify("InitialValue"), Type.U32, Operator.NONE, null, true) });
	public static final MessageTemplate INT64_INSTR = new MessageTemplate(new QName("Int64Instr", NAMESPACE),
			new Field[] { new StaticTemplateReference(PRIM_FIELD_BASE),
					new Scalar(qualify("InitialValue"), Type.I64, Operator.NONE, null, true) });
	public static final MessageTemplate UINT64_INSTR = new MessageTemplate(new QName("UInt64Instr", NAMESPACE),
			new Field[] { new StaticTemplateReference(PRIM_FIELD_BASE),
	...
	public static final MessageTemplate UNICODE_INSTR = new MessageTemplate(new QName("UnicodeInstr", NAMESPACE),
			new Field[] { new StaticTemplateReference(PRIM_FIELD_BASE_WITH_LENGTH),
					new Scalar(qualify("InitialValue"), Type.UNICODE, Operator.NONE, null, true) });
	//NGTS Enhancement for GBK support
	public static final MessageTemplate GBK_INSTR = new MessageTemplate(new QName("GbkInstr", NAMESPACE), new Field[] {
			new StaticTemplateReference(PRIM_FIELD_BASE_WITH_LENGTH),
			new Scalar(qualify("InitialValue"), Type.GBK, Operator.NONE, null, true) });
	public static final MessageTemplate ASCII_INSTR = new MessageTemplate(new QName("AsciiInstr", NAMESPACE),
			new Field[] { new StaticTemplateReference(PRIM_FIELD_BASE),
					new Scalar(qualify("InitialValue"), Type.ASCII, Operator.NONE, null, true) });
	public static final MessageTemplate BYTE_VECTOR_INSTR = new MessageTemplate(new QName("ByteVectorInstr", NAMESPACE),
			new Field[] { new StaticTemplateReference(PRIM_FIELD_BASE_WITH_LENGTH),
					new Scalar(qualify("InitialValue"), Type.BYTE_VECTOR, Operator.NONE, null, true) });
	public static final MessageTemplate TYPE_REF = new MessageTemplate(new QName("TypeRef", NAMESPACE),
			new Field[] { new Group(qualify("TypeRef"), new Field[] { new StaticTemplateReference(NS_NAME),
					new StaticTemplateReference(OTHER) }, true) });
	public static final MessageTemplate TEMPLATE_DECLARATION = new MessageTemplate(new QName("TemplateDecl", NAMESPACE),
			new Field[] { new StaticTemplateReference(TEMPLATE_NAME), u32("TemplateId") });
	public static final MessageTemplate TEMPLATE_DEFINITION = new MessageTemplate(new QName("TemplateDef", NAMESPACE),
			new Field[] { new StaticTemplateReference(TEMPLATE_NAME), unicodeopt("AuxId"), u32opt("TemplateId"),
	...
	public static final MessageTemplate TAIL_OP = new MessageTemplate(new QName("TailOp", NAMESPACE),
			new Field[] { new StaticTemplateReference(OP_BASE) });
	public static final MessageTemplate GROUP_INSTR = new MessageTemplate(new QName("GroupInstr", NAMESPACE),
			new Field[] { new StaticTemplateReference(FIELD_BASE), new StaticTemplateReference(TYPE_REF),
					new Sequence(qualify("Instructions"), new Field[] { DynamicTemplateReference.INSTANCE }, false) });
	public static final MessageTemplate SEQUENCE_INSTR = new MessageTemplate(new QName("SequenceInstr", NAMESPACE),
			new Field[] {
					...
					new Group(qualify("Length"), new Field[] {
							...
							new StaticTemplateReference(OTHER), }, true),
					new Sequence(qualify("Instructions"), new Field[] { DynamicTemplateReference.INSTANCE }, false) });
	public static final MessageTemplate STAT_TEMP_REF_INSTR = new MessageTemplate(new QName("StaticTemplateRefInstr",
			NAMESPACE), new Field[] { new StaticTemplateReference(TEMPLATE_NAME), new StaticTemplateReference(OTHER) });
	public static final MessageTemplate DYN_TEMP_REF_INSTR = new MessageTemplate(new QName("DynamicTemplateRefInstr",
			NAMESPACE), new Field[] { new StaticTemplateReference(OTHER) });
	...
	public static final MessageTemplate TEXT = new MessageTemplate(qualify("Text"), new Field[] { new Scalar(
			qualify("Value"), Type.UNICODE, Operator.NONE, ScalarValue.UNDEFINED, false) });
	public static final MessageTemplate COMP_DECIMAL_INSTR = new MessageTemplate(qualify("CompositeDecimalInstr"),
			new Field[] {
					new StaticTemplateReference(FIELD_BASE),
					...
					new Group(qualify("Mantissa"), new Field[] {
							...
							new Scalar(qualify("InitialValue"), Type.I32, Operator.NONE, ScalarValue.UNDEFINED, true),
							new StaticTemplateReference(OTHER) }, true) });
	public static final FastMessage DYN_TEMP_REF_MESSAGE = new FastMessage(DYN_TEMP_REF_INSTR);
	...
	static {
		...
		// NGTS Enhancement for GBK supportK
		TEMPLATE_REGISTRY.register(GBK_INSTR_ID, GBK_INSTR);
	...
	private static final FastMessage CLOSE = createFastAlertMessage(SessionConstants.CLOSE);
}
