...
public class ComposedDecimalParser extends AbstractFieldParser {
	 ...
	 */
	private Field createComposedDecimal(Element fieldNode, QName name, boolean optional, Node mantissaNode,
			Node exponentNode, ParsingContext context) {
		...
		ComposedScalar scalar = Util.composedDecimal(name, Operator.getOperator(exponentOperator), exponentDefaultValue,
				Operator.getOperator(mantissaOperator), mantissaDefaultValue, optional);
