...
final class DeltaStringOperatorCodec extends AlwaysPresentOperatorCodec {
	...
	DeltaStringOperatorCodec() {
		...
		super(Operator.DELTA, new Type[] { Type.ASCII, Type.STRING, Type.UNICODE, Type.BYTE_VECTOR, Type.GBK });
	}
	...
	public ScalarValue getValueToEncode(ScalarValue value, ScalarValue priorValue, Scalar field) {
		...
		if (priorValue == null) {
			Global.handleError(FastConstants.D6_MNDTRY_FIELD_NOT_PRESENT, "The field " + field
					+ " must have a priorValue defined.");
			return null;
		}
