...
public abstract class OperatorCodec implements Serializable {
	...
	protected static final OperatorCodec INCREMENT_INTEGER = new IncrementIntegerOperatorCodec(Operator.INCREMENT,
			Type.INTEGER_TYPES);
	...
	protected static final OperatorCodec TAIL = new TailOperatorCodec(Operator.TAIL, new Type[] { Type.ASCII,
			Type.STRING, Type.UNICODE, Type.BYTE_VECTOR, Type.GBK });
	 ...
	 */
	public ScalarValue getValueToEncode(ScalarValue value, ScalarValue priorValue, Scalar scalar,
