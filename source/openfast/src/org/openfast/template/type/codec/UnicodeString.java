...
final class UnicodeString extends NotStopBitEncodedTypeCodec {
	...
	public byte[] encodeValue(ScalarValue value) {
		try {
			...
			//byte[] utf8encoding = ((StringValue) value).value.getBytes("GBK");
			return TypeCodec.BYTE_VECTOR.encode(new ByteVectorValue(utf8encoding));
		} catch (UnsupportedEncodingException e) {
			throw new FastException("Apparently Unicode is no longer supported by Java.", FastConstants.IMPOSSIBLE_EXCEPTION,
					e);
		}
	}
